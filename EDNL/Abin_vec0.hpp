...
template <typename T>
Abin<T>::Abin(size_t maxNodos) : nodos{new celda[maxNodos]},
                                 maxNodos{maxNodos},
                                 numNodos{0}
{
    if (maxNodos > 1)
    { // Crear la lista de celdas
...
//devuelve el tamaño maximo del arbol
template <typename T>
...
//devuelve el numero maximo de nodos
template <typename T>
